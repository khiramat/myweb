...
require_once("inc_edit_data.php");
...
<div id="content">
  <div class="container"> 
    ...
    <!-- サイドバー開始 -->
    <div id="nav">
      <form id="form1" name="form1" method="post" action="data_update_query.php">
       <input type="hidden" name="DivingLogID" value="<?=$DivingLogID?>" />
        ...
        <div class="section strong">
          <div class="inner">
            <h2>テクニカルデータ</h2>
            エントリー
            <input name="entry_hour" type="text" id="entry_hour" size="2" maxlength="2" value="<?=$EntryTimetime_hour?>" />
            :
            <input name="entry_minit" type="text" id="entry_minit" size="2" maxlength="2" value="<?=$EntryTimetime_minites?>" />
            / エグジット
            <input name="exit_hour" type="text" id="exit_hour" size="2" maxlength="2" value="<?=$ExitTimetime_hour?>" />
            :
            <input name="exit_minit" type="text" id="exit_minit" size="2" maxlength="2" value="<?=$ExitTimetime_minites?>" />
						<img src="../image/space.png" alt="space" width="20" height="10" align="absmiddle" />
            最大深度
            <input name="MaximumDepth" type="text" id="MaximumDepth" size="4" maxlength="4" value="<?=$MaximumDepth_last?>" />
            / 平均深度
            <input name="AvarageDepth" type="text" id="AvarageDepth" size="4" maxlength="4" value="<?=$AvarageDepth_last?>" />
            m <img src="../image/space.png" alt="space" width="20" height="10" align="absmiddle" />
						初圧
            <input name="StartPressure" type="text" id="StartPressure" size="3" maxlength="3" value="<?=$StartPressure_last?>" />
            / 残圧
            <input name="EndPressure" type="text" id="EndPressure" size="3" maxlength="3" value="<?=$EndPressure_last?>" />
            bar </div>
        </div>
        <div class="section emphasis">
          <div class="inner">
        ...
        <div class="section normal">
          ...
          <img src="../image/space.png" alt="space" width="20" height="10" align="absmiddle" />|<img src="../image/space.png" alt="space" width="20" height="10" align="absmiddle" />メンバー
