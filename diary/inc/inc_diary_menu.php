...
<div class="link_head1"><a href="/diary/diary_graph.php" class="menu-lnk">* Health Parameter</a>
</div><!-- <div class="link_head1"><a href="/diary/diary_add_m_tusk.php" class="menu-lnk">* Add</a></div> --><!-- <div class="link_head1"><a href="http://gallery.me.com/kyo_h/" class="menu-lnk" target="_blank">* Gallery</a></div>
...
<div class="link_head1"><a href="/diving/index.php" class="menu-lnk" target="_blank">* Diving Log</a></div>
...
<div class="menuap">
	<select name="date_old" class="icon" onChange="MM_jumpMenu('parent',this,0)">
        ...
        ";
        $result_YM = mysqli_query($link, $sql);
        while ($row_YM = mysqli_fetch_array($result_YM)) {
            $ym = substr($row_YM["ym"], 0, 4). "-". substr($row_YM["ym"], 4);
