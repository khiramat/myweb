...
<div class="card card-default">
    ...
    <div class="card-body">
        <form action="javascript:void(0);" id="account_update">
            ...
            <div><div style="font-weight: bold">詳細</div><div><?php echo nl2br($com) ?></div></div>
            <div class="form-group" style="margin-top: 20px;">
                <label>詳細 アップデート用</label>
                <textarea name="com" class="form-control form-control-sm"
                          style="height: calc(1.3em * 20); line-height: 1.3;"><?= $com ?></textarea>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">

                    <input type="hidden" name="id" value="<?= $id ?>">
                    <button type="submit" name="submit" class="btn badge-primary btn-sm" id="account_update_btn">
                        Update
                    </button>
        </form>
    </div>
